...
class ProofRequestCompleteSellerWidget extends AbstractChatCard {
  ProofRequestCompleteSellerWidget({
    super.key,
    super.node
  });
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text("Buyer's name: $buyerName"),
            Text("Verified by the goverment of Finland."),
