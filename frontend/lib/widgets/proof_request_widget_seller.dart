...
class ProofRequestWidgetSeller extends StatefulWidget {
  final String sentBy;
  ...
  const ProofRequestWidgetSeller({
    super.key,
    required this.id,
...
class ProofRequestWidgetBuyerState extends State<ProofRequestWidgetSeller> {
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            const Text('Provide receipt to the buyer'),
